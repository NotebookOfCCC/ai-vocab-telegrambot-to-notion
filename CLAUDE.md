...
53. **Grammar Chinese hints**: Grammar cards now show Chinese translation of the sentence below the fill-in-blank question. Uses one Haiku batch call per session (~$0.001). Phrase cards already have Chinese prompts so no translation needed.
