...
73. **Review TTS voice selector**: Review bot Schedule settings now include [Edit Voice] button — choose from 4 en-GB voices (Sonia, Libby, Ryan, Thomas). Voice preference persisted in config DB.
