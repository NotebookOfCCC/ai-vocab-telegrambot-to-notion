...
Runs all six Telegram bots as separate processes:
...
6. story_bot.py - Story Bot (fleeting thoughts to Obsidian)
...
def main():
    ...
    story_process = subprocess.Popen([sys.executable, "story/story_bot.py"])
    ...
    print(f"Story bot PID: {story_process.pid}")
